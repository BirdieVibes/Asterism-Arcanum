...
//currently very reliant on aces electromancer class
public class AstromancerEntity extends NeutralWizard implements IMerchantWizard {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new WizardAttackGoal(this, 1.5f, 25, 40)
                .setSpells(// Attack
                        List.of(SpellRegistries.LUMINOUS_FLARE.get(), SpellRegistries.STARFIRE.get(), SpellRegistry.GUIDING_BOLT_SPELL.get()),
                        // Defense
                        List.of(SpellRegistry.OAKSKIN_SPELL.get(), SpellRegistry.HEAL_SPELL.get(), SpellRegistries.DARK_FLOW.get()),
                        // Movement
    ...
    protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
        ...
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(ItemRegistry.CRYOMANCER_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ItemRegistry.CRYOMANCER_BOOTS.get()));
    ...
    public MerchantOffers getOffers() {
        if (this.offer == null)
        {
            ...
            this.offer.add(new MerchantOffer(
                    ...
                    new ItemStack(ItemRegistry.AMETHYST_RAPIER.get(), 1),
                    2,
                    0,
                    1.2F
            ));
    ...
    private static final List<VillagerTrades.ItemListing> filler = List.of(
            new AdditionalWanderingTrades.SimpleBuy(1, new ItemCost(ASARItemsRegistry.LIQUID_LUMINANCE_BOTTLE.get(), 1), 6, 12),
            new AdditionalWanderingTrades.SimpleSell(1, new ItemStack(ASARItemsRegistry.ASTRAL_RUNE.get(), 2), 25, 55),
            new AdditionalWanderingTrades.SimpleSell(1, new ItemStack(ASARItemsRegistry.LIQUID_LUMINANCE_BOTTLE.get(), 1), 6, 12)
    );
