...
public class ConstellationRenderer extends EntityRenderer<Constellation> {
    ...
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(IronsSpellbooks.MODID,
            "ball_lightning_model"), "main");
    private static final ResourceLocation SWIRL_TEXTURES =
           ResourceLocation.fromNamespaceAndPath(AsterismArcanum.MOD_ID, "textures/entity/constellation/constellation.png");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("orb", CubeListBuilder.create().texOffs(0,
                0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), PartPose.ZERO);
