...
public class CelestialTetherRenderer extends EntityRenderer<CelestialTetherEntity> {
    ...
    private final TetherModel model;

    public CelestialTetherRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new TetherModel(pContext.bakeLayer(TetherModel.LAYER_LOCATION));
    }

    public void render(CelestialTetherEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource multiBufferSource, int light) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(CelestialTetherEntity pEntity) {
        return NOCULL;
    }

    public static class TetherModel extends EntityModel<CelestialTetherEntity> {
        ...
        public TetherModel(ModelPart root) {
        ...
        @Override
        public void setupAnim(CelestialTetherEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        }
    }
}
